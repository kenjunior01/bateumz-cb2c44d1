...
export default function SnakeBattle({ onScore, liveCode }: Props) {
  ...
  const [winner, setWinner] = useState<"Jogador 1" | "Jogador 2" | "empate" | null>(null);
    ...
    const handleKey = (e: KeyboardEvent) => {
      ...
      switch (e.key.toLowerCase()) {
        ...
        case "d":
          ...
          break;
        case "arrowup":
          if (s2.direction !== "down") s2.nextDirection = "up";
          e.preventDefault();
          break;
        case "arrowdown":
          if (s2.direction !== "up") s2.nextDirection = "down";
          e.preventDefault();
          break;
        case "arrowleft":
          if (s2.direction !== "right") s2.nextDirection = "left";
          e.preventDefault();
          break;
        case "arrowright":
          if (s2.direction !== "left") s2.nextDirection = "right";
          e.preventDefault();
          break;
      }
    };
        ...
        <AnimatePresence>
          {gameState === "waiting" && (
            ...
            >
              ...
              <Button
                onClick={startGame}
                className="bg-gradient-to-r from-cyan-600 to-pink-600 hover:from-cyan-500 hover:to-pink-500 text-white font-semibold px-6"
              >
                Iniciar Jogo
              </Button>
            </motion.div>
          ...
          {gameState === "gameOver" && winner && (
            ...
            >
              ...
              <div className="flex gap-3">
                <Button
                  onClick={nextRound}
                  className="bg-gradient-to-r from-cyan-600 to-pink-600 hover:from-cyan-500 hover:to-pink-500 text-white font-semibold"
                >
                  Próximo Round
                </Button>
                <Button
