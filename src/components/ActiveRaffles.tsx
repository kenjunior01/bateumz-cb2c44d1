          ...
          {raffles.map((r, i) => (
            ...
            >
              ...
              <div className="relative h-48 overflow-hidden">
                ...
                <span className={`absolute left-3 top-3 rounded-full px-3 py-1 text-xs font-semibold ${r.tagColor}`}>
                  {r.tag}
                </span>
              </div>
              ...
              <div className="p-5">
                ...
                {/* CTA */}
                <button className="flex w-full items-center justify-center gap-2 rounded-xl bg-primary py-3 text-sm font-semibold text-primary-foreground transition-opacity hover:opacity-90">
