...
const OverlayLive = () => {
  ...
  return (
    <div className="min-h-screen bg-transparent text-white p-6 font-display">
      {view === "ranking" && (
        <div className="rounded-3xl bg-black/70 backdrop-blur-md border border-white/10 p-5 max-w-md">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h2 className="font-extrabold text-lg">Top embaixadores</h2>
            <span className="ml-auto text-[10px] uppercase bg-red-500 px-2 py-0.5 rounded-full">AO VIVO</span>
          </div>
      ...
      {view === "prizes" && (
        <div className="rounded-3xl bg-black/70 backdrop-blur-md border border-white/10 p-5 max-w-md">
          <div className="flex items-center gap-2 mb-3"><Trophy className="h-5 w-5 text-amber-400" /><h2 className="font-extrabold text-lg">Prémios desta live</h2></div>
          <ul className="space-y-2">
            {prizes.map((p) => (
