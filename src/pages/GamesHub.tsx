...
const GAME_CATEGORIES: GameCategory[] = [
  ...
  },
  {
    ...
    games: [
      ...
      {
        id: "live-quiz",
        title: "Quiz Futebol Ao Vivo",
        description: "Perguntas sobre jogos reais em tempo real",
        emoji: "🧠",
        link: "/mundial/quiz",
        isNew: true,
      },
      {
        id: "score-challenge",
        title: "Desafio de Resultado",
        description: "Preveja o placar exacto do próximo jogo",
        emoji: "🎯",
        link: "/mundial/score-challenge",
        isNew: true,
      },
      {
        id: "golden-boot",
        title: "Bota de Ouro",
        description: "Aposte no melhor marcador do Mundial",
        emoji: "👟",
        link: "/mundial/golden-boot",
        isNew: true,
      },
      {
        id: "forum",
