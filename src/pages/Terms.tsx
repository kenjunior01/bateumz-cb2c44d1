  ...
  return (
    <div className="min-h-screen bg-background pb-16 lg:pb-0">
      ...
      <main className="container mx-auto px-6 py-24">
        ...
        >
          <div className="absolute -inset-4 rounded-3xl bg-gradient-to-br from-primary/8 via-accent/5 to-primary/8 blur-xl -z-10" />
        ...
        <div className="max-w-3xl space-y-6">
          {content.sections.map((section, index) => (
            <motion.section
              ...
              whileHover={{ y: -2 }}
              className="group rounded-2xl border border-border/60 bg-card/50 p-6 md:p-8 transition-colors hover:border-primary/20 hover:bg-card/80"
            >
              <div className="flex items-start gap-4">
                <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-primary/15 to-accent/10 text-xs font-bold text-primary">
                  {index + 1}
                </span>
